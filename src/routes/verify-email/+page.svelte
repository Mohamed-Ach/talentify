...
<section class="max-h-screen max-w-screen overflow-hidden dark:bg-gray-800">
	<div class="flex flex-col items-center justify-evenly mx-auto h-screen px-4 sm:px-6 lg:px-8">
		<a href="/">
			<img src={logo} alt="Login" class="dark:hidden" />
			<img src={logoWhite} alt="Login" class="hidden dark:block" />
		</a>
			...
			<div class="border border-indigo-300 h-[550px] rounded-lg w-full">
				...
				{#if data.verify.status === 200}
					<div class="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
						<SealCheck size={128} weight="duotone" class="text-indigo-600" />
						<div class="block text-center mt-5">
							<h5
								class="md:text-xl text-lg leading-8 text-gray-900 dark:text-white font-medium mb-1.5"
							>
								<span class="text-indigo-600 font-semibold">Hooray!</span> Email Verified
							</h5>
					...
					<div class="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
						...
						<div class="block text-center mt-5">
							<h5
								class="md:text-xl text-lg leading-8 text-gray-900 dark:text-white font-medium mb-1.5"
							>
								<span class="text-indigo-600 font-semibold">Oops!</span> Something went wrong.
							</h5>
							<p class="font-primary text-sm text-gray-500">
								This Link is probably Invalid or has expired.
							</p>
						</div>
					</div>
				{/if}
